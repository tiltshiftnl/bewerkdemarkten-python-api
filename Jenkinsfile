...
String PROJECTNAME = "scpp_bewerkdemarkten_api"
String CONTAINERDIR = "."
...
String CONTAINERNAME = "fixxx/scpp_bewerkdemarkten_api:${env.BUILD_NUMBER}"
...
if (BRANCH == "${PRODUCTION_BRANCH}") {
    ...
    stage('Waiting for approval') {
        slackSend channel: '#ci-channel-app', color: 'warning', message: 'scpp-bewerkdemarkten-api is waiting for Production Release - please confirm'
